  ...
  const features = [
    {
      ...
      description: "Todos nuestros trabajos cumplen con las normativas SEC y estándares de seguridad más exigentes."
    },
    {
      icon: Award,
      title: "Experiencia Comprobada",
      description: "Más de 10 años de experiencia en instalaciones eléctricas residenciales y comerciales."
    },
    {
      icon: Clock,
      title: "Respuesta Rápida",
      description: "Atención oportuna para emergencias y proyectos. Estamos cuando nos necesitas."
    },
    {
      icon: MapPin,
      title: "Servicio Local",
      description: "Basados en Villa Prat, atendiendo toda la zona de Curicó con cercanía y compromiso."
    }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative animate-fade-in">
              <div className="bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl p-8 shadow-card">
                <div className="aspect-square bg-gradient-to-br from-primary to-primary/80 rounded-xl flex items-center justify-center text-white text-6xl font-bold shadow-glow">
                  DH
                </div>
              </div>
